...
export default function Coin() {
    ...
    <main className=" absolute top-0 z-40 flex w-[100vw] h-[100vh]">
        <section className=" flex flex-col self-center gap-12 w-fit h-fit max-h-[95vh] bg-white bg-opacity-60 rounded-3xl backdrop-blur-md mx-auto px-7 py-12 overflow-y-scroll scrollbarhidden">
           <h1 className=" font-ouroboros self-center text-7xl">Boutique</h1> 
           <div className=" flex flex-col">
            <h2 className=" font-ouroboros text-[--primary] text-lg px-5 py-2">Beacoin</h2>
           ...
           <div className=" flex flex-col">
                <h2 className=" font-ouroboros text-[--primary] text-lg px-5 py-2">DLC</h2>
                <div className=" flex flex-col ring-2 ring-[--primary] rounded-xl w-[70vw] py-5">
            ...
            *30% des benefices engendré par la boutique seront reversés à des asssociations de protection des phares.
            <br />
            Le reste sert à financer le site et les frais de fonctionnement.
           </p>
        </section>
    </main>
    </>
