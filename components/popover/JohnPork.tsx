...
export default function SmallEnigme({ handleClickPopup, codeLock, coordX, coordY, name, question, text1, answer, text2 }: SmallEnigmeProps) {
    return (
            <section    style={{left: `${coordX}vw`, top:`${coordY-2}vw`}} 
                ...
                <div className='flex flex-col items-center'>
                    ...
                    <span>{question}</span>
                    <span>{text1}</span>
                    <input className="flex items-center" type="text" placeholder='entrez la réponse ici'/>
                    <span>{text2}</span>
                </div>
