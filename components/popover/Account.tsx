...
export default function Account({ active, handleClickActive }: MenuProps) {
    ...
    const handleSignOut = async () => {
        ...
        redirect('/')// Ou redirigez vers une autre page de votre choix
    };
            ...
            <div className=" flex justify-center items-center gap-32">
                ...
                <div className=" flex flex-col gap-2">
                    ...
                    <div className=" flex justify-around">
                        <div onClick={() => handleClickActive('coin')} className=" flex items-center gap-2 border border-[--text] rounded-full mt-7 py-1 px-4 cursor-pointer hover:scale-110 duration-300">
                        ...
                        <div onClick={() => handleClickActive('home')} className=" flex items-center gap-2 border border-[--text] rounded-full mt-7 py-1 px-4 cursor-pointer hover:scale-110 duration-300">
                            <Image src="/images/lighthouse.png" width={30} height={30} alt="icon de phare"></Image>
                            <p>2/256</p>
                        </div>
                    </div>
                </div>
                <div onClick={handleSignOut} className=" cursor-pointer hover:scale-110 duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className=" size-12">
