...
class Player extends Component<PlayerProps, PlayerState> {
    ...
    create  = ( user: User, becoins: number, current_wolrd: number, nb_completed_lh: number ) => {
    ...
    update = (user: User, becoins: number, current_wolrd: number, nb_completed_lh: number ) => {
