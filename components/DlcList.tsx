...
interface DlcListProps {
    ...
    const mapExtention: { [key: number]: [string, number, number,[[number, number],[number,number]]] } = {
        0:["France",-1.6282904, 49.6299822,[[-5.127287501115138,41.77913251512358],[10.429352882451159,51.69268051974335]]],
        1:["Guadeloupe-Martinique",-61.577007207411725,16.246965622581968,[[-61.95578838889018,14.46119739625245],[-60.47036547887585,16.713124325221894]]],
