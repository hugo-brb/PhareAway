...
import Portfeuille from "@/components/Coin"
    ...
    <main className=" land flex w-[100vw] h-[100vh]">
        ...
        <section className=" flex flex-col self-center gap-12 w-fit h-fit max-h-[95vh] bg-white bg-opacity-60 rounded-3xl backdrop-blur-md mx-auto px-7 py-12 overflow-y-scroll scrollbarhidden">
           ...
           <div className=" flex flex-col">
            <h2 className=" font-bold text-lg px-5 py-2">Becoin</h2>
            <div className=" flex flex-col border border-[--text] rounded-xl w-[70vw] py-5">
                    <div className=" flex ml-7 justify-around">
                        <div className=" flex flex-col justify-center items-center gap-3 px-7 py-5 hover:border hover:border-[--text] rounded-xl duration-100 cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="fill-[--accent] duration-300 size-24">
           ...
           <div className=" flex flex-col">
                <h2 className=" font-bold text-lg px-5 py-2">DLC</h2>
                <div className=" flex flex-col border border-[--text] rounded-xl w-[70vw] py-5">
                    <div className=" flex ml-7 justify-center gap-24">
                        <div className=" flex flex-col justify-center items-center gap-3 px-7 py-5 hover:border hover:border-[--text] rounded-xl duration-100 cursor-pointer">
                            ...
                            <div className=" flex flex-col justify-center items-center">
                                <p>Corse</p>
                                <p className=" opacity-50">100 Becoins</p>
                            </div>
                        </div>
                        ...
                        <div className=" flex flex-col justify-center items-center gap-3 px-7 py-5 hover:border hover:border-[--text] rounded-xl duration-100 cursor-pointer">
                            ...
                            <div className=" flex flex-col justify-center items-center">
                                <p>Dom-Tom</p>
                                <p className=" opacity-50">1.000 Becoins</p>
                            </div>
                        </div>
                    </div>
                </div>
