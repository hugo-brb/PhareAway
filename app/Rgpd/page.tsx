...
export default function Rgpd() {
  ...
  const verif = () => {
    if (email && name && age && accept) {
      ...
      setErrorMessage(
        "Toutes les conditions doivent être validées pour pouvoir continuer l'inscription..."
      );
    }
  };
          ...
          {flipped && (
            <>
              <p className=" max-w-[45vw]">
                ...
                <br />
                <br />
                Afin de vous offrir une expérience personnalisée, nous
                collectons certaines de vos données nécessaires à la création et
                à la gestion de votre compte. Soyez assuré que ces informations
                ne seront utilisées que dans ce but précis : vous permettre de
                profiter pleinement de PhareAway. Nous garantissons qu’aucune
                donnée ne sera exploitée à des fins commerciales, ni pour
                l’envoi d’offres promotionnelles non sollicitées.
                <br />
                <br />
                Veuillez noter que l’accès à PhareAway est réservé aux
                ...
                <br />
                <br />
                Pour plus d’information n’hésitez pas à consulter la liste de traitement de vos données <a href="https://docs.google.com/spreadsheets/d/1ZIKauep4BZjLMNJDZaH3u0IWwHc94P4qpu0sP19GdE0/edit?usp=sharing" target="_blank" className="text-[--primary]">ici</a>.
              </p>
              <button
                onClick={handleFlipped}
                className=" self-center w-32 py-2 px-4 text-xl font-bold rounded-3xl hover:bg-[--primary] hover:text-[--background] ring-2 ring-[--primary] duration-300 ease-in-out"
              >
                Retour
              </button>
            </>
