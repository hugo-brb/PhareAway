...
export default function Account() {
    return <>
    <main className=" land flex w-[100vw] h-[100vh]">
        <Menu active="account"/>
            ...
            <div className=" flex justify-center items-center gap-32">
                ...
                <div className=" flex flex-col gap-2">
                    ...
                    <div className=" flex justify-around">
                        <Link href="/Coin" className=" flex items-center gap-2 border border-[--text] rounded-full mt-7 py-1 px-4">
                        ...
                        <Link href="/Home" className=" flex items-center gap-2 border border-[--text] rounded-full mt-7 py-1 px-4">
            ...
            <div className=" flex flex-col gap-12 pl-7 mx-auto px-7 py-12">
                <div className=" flex gap-12">
                    <div className=" flex flex-col gap-1">
                        ...
                        <input type="text" defaultValue="Soleil" className=" py-2 px-4 w-fit rounded-full bg-white bg-opacity-45" />
                    </div>
                    <div className=" flex flex-col gap-1">
                        <h3 className=" font-bold text-xl">Prénom</h3>
                        <input type="text" defaultValue="François" className=" py-2 px-4 w-fit rounded-full bg-white bg-opacity-45" />
                    </div>
                </div>
                <div className=" flex flex-col gap-1">
                    <h3 className=" font-bold text-xl">Nom d'utilisateur</h3>
                    <input type="text" defaultValue="Pharaon" className=" py-2 px-4 w-full rounded-full bg-white bg-opacity-45" />
                </div>
                <div className=" flex flex-col gap-1">
                    <h3 className=" font-bold text-xl">Email</h3>
                    <input type="mail" defaultValue="phareaway@lighthouse.fr" className=" py-2 px-4 w-full rounded-full bg-white bg-opacity-45" />
                </div>
                <div className=" flex flex-col gap-1">
                    <h3 className=" font-bold text-xl">Mot de passe</h3>
                    <input type="password" defaultValue="Jaimelesphares38" className=" py-2 px-4 w-full rounded-full bg-white bg-opacity-45" />
                </div>
